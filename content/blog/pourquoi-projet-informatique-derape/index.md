---
title: "Pourquoi ton projet informatique dérape et comment le sauver"
description: "70% des projets ERP en PME dépassent le budget ou les délais. Voici ce qui se passe vraiment, et comment réagir avant que ça coûte trop cher."
date: 2026-05-04
...
faq:
  ...
  - q: "Est-ce que c'est toujours la faute de l'intégrateur ?"
    a: "Non. Dans la majorité des cas que j'ai vus, c'est une combinaison. L'intégrateur répond à ce qu'il a entendu, pas toujours à ce que le client voulait dire. Et le client n'a souvent pas formalisé ses besoins avec suffisamment de précision. Le problème, c'est l'absence d'un tiers qui peut challenger les deux côtés."
  - q: "Quand est-ce qu'on arrête un projet informatique ?"
...
Selon le [Standish Group CHAOS Report](https://www.standishgroup.com/sample_research_files/CHAOSReport2015-Final.pdf), 31% des projets informatiques sont abandonnés avant d'être déployés. Et 70% des projets ERP n'atteignent pas leurs objectifs initiaux.
...
C'est pour ça que [choisir un logiciel](/blog/choisir-logiciel-gestion-pme/) n'est pas une décision à prendre uniquement sur la base d'une démo.
...
![Un consultant fait le pont entre équipe business et intégrateur technique](/images/blog/pourquoi-projet-informatique-derape/interne.webp)
...
C'est exactement ce que je fais sur les missions d'[accompagnement projet informatique](/services/accompagnement-projet-informatique/).
